...
1. Fork the repository, clone your fork, and create a dedicated branch (see [Branch and Commit Discipline](#branch-and-commit-discipline)).
2. Make the change in a focused scope and stay within the task boundary.
3. Run the required checks before opening a PR (see [Recommended Validation](#recommended-validation)).
4. Open the pull request from your fork to the upstream repository and wait for CI to pass.
