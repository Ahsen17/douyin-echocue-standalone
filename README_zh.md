...
- [ ] M5 Provider 与实时编排 — Provider 配置/连接测试、稳定的 `TextGenerationProvider`、DeepSeek 与 OpenAI-compatible 双 adapter、确定性 PromptAssembler、实时 `SuggestionAttempt` 编排。*（已完成 5/9）*
- [ ] M6 正式 Renderer 与独立浮窗 — 七个正式功能入口与独立置顶浮窗。
