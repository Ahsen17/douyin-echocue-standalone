...
本文件维护 W1–W7 工作包、测试用例与验收门禁。具体开发领取顺序、任务前置依赖、最小阅读章节、输入 artifact、输出物和单任务 DoD，统一见 [《MVP 里程碑与原子任务实施计划》](Echocue-MVP里程碑与原子任务实施计划-v0.1.md)；程序人员应从该计划领取原子任务，不以通读全部文档作为开工前提。
